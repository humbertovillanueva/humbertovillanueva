...
| Area | Technologies |
| :--- | :--- |
| **Languages** | TypeScript · JavaScript · Python · Java · Fantom |
| **Frontend** | React · Next.js · Svelte · Tailwind |
| **Backend & APIs** | Node.js · Django · Flask · Spring · REST APIs |
| **Data** | PostgreSQL · Redis · Firebase |
| **Cloud & tools** | AWS · Docker · Git/GitHub · Linux |
...
**Everything eventually needs a V2.** I enjoy figuring out what that next version should be.
